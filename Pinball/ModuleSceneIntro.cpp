...
bool ModuleSceneIntro::Start()
{
	...
	// Textures
	circle = App->textures->Load("pinball/pinball.png"); // Ball sprite that does not work
	...
	*/
	...
	music_played = App->audio->PlayMusic("pinball/Gourment Race.ogg", 0.0f);
...
update_status ModuleSceneIntro::Update()
{
	...
	{
		music_played = App->audio->PlayMusic("pinball/Gourment Race.ogg", 2.0f);
	}
	else {}
...
void ModuleSceneIntro::OnCollision(PhysBody* bodyA, PhysBody* bodyB)
{
	...
	else
	{
		...
		{
			Mix_HaltMusic();
			music_played = App->audio->PlayMusic("pinball/Final-Fantasy-Victory.wav", 0.0f);
